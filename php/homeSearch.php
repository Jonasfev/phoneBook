...
<body>
    <nav class="navbar navbar-white bg-white">
        ...
        <div class="button" id="button-7">
            <form action="#">
                <input id="dub-arrow" type="text" name="pesquisar" id="pesquisar">
        ...
        <div class="button" id="button-7">
            <div id="dub-arrow"><img src="https://www.flaticon.com/svg/static/icons/svg/709/709624.svg" onclick="location.href = 'home.php';"></div>
            <a href="#">Voltar</a>
        </div>
    ...
    <div class="fundo">
        ...
        <div class="card" style="width: 18rem;">
            <div class="list-group">
                ...
                <?foreach($nome as $nomes){
                    if($nomes->nome == strtoupper($_GET['nome'])){?>
